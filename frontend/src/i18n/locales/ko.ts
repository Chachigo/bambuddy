export default {
  ...
  printers: {
    ...
    autoChamberLightTooltip: '챔버 조명이 프린트를 따라감 (시작 시 켜짐, 종료 후 꺼짐)',
    cameraChamberLightTooltip: '이 프린터의 카메라를 보는 동안 챔버 조명을 켜 둠',
    ...
    toast: {
      ...
      autoChamberLightEnabled: '자동 조명 켜짐',
      autoChamberLightDisabled: '자동 조명 꺼짐',
      cameraChamberLightEnabled: '카메라 조명 켜짐',
      cameraChamberLightDisabled: '카메라 조명 꺼짐',
